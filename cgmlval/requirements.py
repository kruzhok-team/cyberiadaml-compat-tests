...
REQUIREMENTS = {
    ...
    "CGML-6.8-3-1": Req(MUST, "RWX", CORE, PENDING),
    "CGML-6.8-4": Req(MUST, "RW", CORE, VALIDATOR),
    "CGML-6.8-4-1": Req(MUST, "RWX", CORE, PENDING),
    ...
    "CGML-6.8-5-1": Req(MUST, "RWX", CORE, PENDING),
    "CGML-6.8-5-2": Req(MUST, "RWX", CORE, PENDING),
