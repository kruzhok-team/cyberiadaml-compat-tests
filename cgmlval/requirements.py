...
REQUIREMENTS = {
    ...
    "CGML-6.4-4-2": Req(SHOULD, "RX", CORE, PENDING),
    ...
    "CGML-8.1-1-1": Req(MUST, "RWX", EXT_COMPLETENESS, PENDING),
    "CGML-8.1-2": Req(MUST, "RWX", EXT_COMPLETENESS, VALIDATOR),
    "CGML-8.1-3": Req(MUST, "RWX", EXT_COMPLETENESS, PENDING),
    "CGML-8.1-4": Req(MUST, "RWX", EXT_COMPLETENESS, PENDING),
    ...
    "CGML-8.3-4": Req(MUST, "RWX", EXT_COMPLETENESS, PENDING),
    "CGML-8.3-5": Req(MUST, "RWX", EXT_COMPLETENESS, PENDING),
